...
//        $this->call(RolePermissionsTableSeeder::class); // TODO: Need to fix. For every role there should be certain permissions.
...
//        $this->call(ContactsTableSeeder::class); // TODO: Need to fix faker email and phone values.
